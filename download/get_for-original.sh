...
wget --no-check-certificate "https://bil.eecs.yorku.ca/share/for-original.tar.gz" -O "$DEST/raw/for-original.tar.gz"

echo "Extracting for-original.tar.gz..."
tar -xzvf "$DEST/raw/for-original.tar.gz" -C "$DEST/processed"
