...
# Insert in a folder called "mscenespeech/raw" inside your data root
...
if __name__ == "__main__":
    ...
    main(
        data_folder=os.path.join(hparams["data_root"], "mscenespeech", "raw"),
        dest_folder=os.path.join(hparams["dest_folder"], "mscenespeech", "processed"),
