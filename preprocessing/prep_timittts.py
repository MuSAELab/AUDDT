...
def main(data_folder: str, dest_folder: str, manifest_file: str):
    ...
    dest_wav_path_list = []
    duration_list = []
    for _, row in tqdm(test_set.iterrows(), total=len(test_set), desc="Preprocessing TIMIT-TTS"):
...
if __name__ == "__main__":
    ...
    main(
        data_folder=os.path.join(hparams["data_root"], "timittts", "raw"),
        dest_folder=os.path.join(hparams["dest_folder"], "timittts", "processed"),
